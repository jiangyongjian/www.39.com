...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            ...
            商品管理
                <ul>
                    <li class="menu-item"><a href="/Public/Admin/goodsList.html" target="main-frame">商品列表</a></li>
                    <li class="menu-item"><a href="/Public/Admin/goodsAdd.html" target="main-frame">添加新商品</a></li>
                    <li class="menu-item"><a href="/Public/Admin/categoryList.html" target="main-frame">商品分类</a></li>
                    <li class="menu-item"><a href="/Public/Admin/brandList.html" target="main-frame">商品品牌</a></li>
                    <li class="menu-item"><a href="/Public/Admin/goodsTrash.html" target="main-frame">商品回收站</a></li>
                </ul>
            </li>
